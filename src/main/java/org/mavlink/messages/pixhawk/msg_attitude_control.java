/**
 * Generated class : msg_attitude_control
 * DO NOT MODIFY!
 **/
...
public class msg_attitude_control extends MAVLinkMessage {
  ...
  public msg_attitude_control(int sysId, int componentId) {
    messageType = MAVLINK_MSG_ID_ATTITUDE_CONTROL;
    this.sysId = sysId;
