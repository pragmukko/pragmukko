...
public interface IMAVLinkMessageID {
  ...
  public static int MAVLINK_MSG_ID_ONBOARD_HEALTH = 206;
  ...
  public static int MAVLINK_MSG_ID_IMAGE_TRIGGERED = 152;
  public static int MAVLINK_MSG_ID_V2_EXTENSION = 248;
  public static int MAVLINK_MSG_ID_DEBUG_VECT = 250;
  public static int MAVLINK_MSG_ID_SET_CAM_SHUTTER = 151;
  ...
  public static int MAVLINK_MSG_ID_MARKER = 171;
  ...
  public static int MAVLINK_MSG_ID_WATCHDOG_PROCESS_STATUS = 182;
  public static int MAVLINK_MSG_ID_ENCAPSULATED_DATA = 131;
  public static int MAVLINK_MSG_ID_IMAGE_TRIGGER_CONTROL = 153;
  ...
  public static int MAVLINK_MSG_ID_RAW_AUX = 172;
  public static int MAVLINK_MSG_ID_WATCHDOG_COMMAND = 183;
  ...
  public static int MAVLINK_MSG_ID_SET_POSITION_CONTROL_OFFSET = 160;
  ...
  public static int MAVLINK_MSG_ID_PATTERN_DETECTED = 190;
  ...
  public static int MAVLINK_MSG_ID_VTOL_STATE = 245;
  ...
  public static int MAVLINK_MSG_ID_BRIEF_FEATURE = 195;
  public static int MAVLINK_MSG_ID_WATCHDOG_HEARTBEAT = 180;
  public static int MAVLINK_MSG_ID_SAFETY_ALLOWED_AREA = 55;
  public static int MAVLINK_MSG_ID_POINT_OF_INTEREST = 191;
  ...
  public static int MAVLINK_MSG_ID_WATCHDOG_PROCESS_INFO = 181;
  ...
  public static int MAVLINK_MSG_ID_IMAGE_AVAILABLE = 154;
  ...
  public static int MAVLINK_MSG_ID_POSITION_CONTROL_SETPOINT = 170;
  public static int MAVLINK_MSG_ID_ATTITUDE_CONTROL = 200;
  ...
  public static int MAVLINK_MSG_ID_POINT_OF_INTEREST_CONNECTION = 192;
  ...
  public static int MAVLINK_MSG_ID_DETECTION_STATS = 205;
}
